    ...
    */
    ...
    function SpikeBot() {
        let tmp = Math.random()*0.4;
        let temp_xspeed = RandRangeInt(10,20);
        let temp_yspeed =  RandRangeInt(1,3);
        room.setDiscProperties(0, {x: -50, y: -100 ,xspeed: temp_xspeed, yspeed: temp_yspeed, xgravity: 0, ygravity:0})
    }